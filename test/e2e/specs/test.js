...
module.exports = {
  ...
  'click projects': function(browser) {
    browser
      ...
      .assert.urlEquals(browser.globals.devServerURL + '/projects');
  },
  ...
  'click language spanish': function(browser) {
    browser
      .useXpath()
      .click(
        "/html/body/div[@id='app']/div[@id='main']/footer/div[@class='langComp']/span/a[@class='lang'][2]"
      )
      .useCss()
  ...
  'click language english': function(browser) {
    browser
      ...
      .useXpath()
      .click(
        "/html/body/div[@id='app']/div[@id='main']/footer/div[@class='langComp']/span/a[@class='lang'][1]"
      )
      .useCss()
      .waitForElementNotPresent('.lang', 5000)
